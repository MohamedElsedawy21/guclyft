...
class _ScheduleRideScreenState extends State<ScheduleRideScreen> {
  ...
  Future<void> _schedule() async {
    if (_pickupId == null || _destinationId == null || _scheduledTime == null) {
    ...
    try {
      final result = await RideService.scheduleRide(
  ...
  Widget _buildConfirmation() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text("Ride Scheduled!", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.navy)),
